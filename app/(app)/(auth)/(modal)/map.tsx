...
const Page = () => {
  ...
  const { data: restaurantsMarkers, isLoading: markersIsLoading } =
    useRestaurantMarkers();
  const { data: restaurants, isLoading: restaurantIsLoading } =
    useRestaurants();
  ...
  if (restaurantIsLoading || markersIsLoading) {
    return (
      ...
      <>
        <View style={[styles.header, { paddingTop: insets.top }]}>
          ...
          <View style={styles.headerRight}>
            ...
            <TouchableOpacity style={styles.iconButton} onPress={locateMe}>
